...
let totalFolderSize = calculateSizeOfFolder(directoryTree["/"]);
let folderSizesSorted = folderSizes.sort((a, b) => a - b);

for (let folderSize of folderSizesSorted) {
  if (70000000 - totalFolderSize + folderSize >= 30000000) {
